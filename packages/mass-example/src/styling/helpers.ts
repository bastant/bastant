...
export function backgroundColor(opts: BackgroundColor) {
  switch (opts) {
    case "background":
      return css["background-color-background"];
    default:
      return void 0;
  }
}
...
export function fontWeight(opts: FontWeight) {
  switch (opts) {
    case "thin":
      return css["font-weight-thin"];
    case "light":
      return css["font-weight-light"];
    case "bold":
...
export function fontSize(opts: FontSize) {
  switch (opts) {
    case "pageHeader":
      return css["font-size-pageHeader"];
    case "h1":
      return css["font-size-h1"];
    case "h2":
      return css["font-size-h2"];
    case "h3":
      return css["font-size-h3"];
    case "p":
      return css["font-size-p"];
    case "small":
      return css["font-size-small"];
    default:
      return void 0;
  }
}
