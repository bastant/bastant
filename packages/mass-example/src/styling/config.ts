...
export const SPACINGS = {"mini":"0.5rem","small":"0.75rem","normal":"1.5rem","large":"3rem"}  as const;
...
export const BREAKPOINTS = {"mobile":"min-width: 0","tablet":"min-width: 800px","desktop":"min-width: 1200px","largeDesktop":"min-width: 1800px"}  as const;
export function breakpoints(variable : keyof typeof BREAKPOINTS) : string | undefined {
...
export function fontWeights(variable : keyof typeof FONT_WEIGHTS) : string | undefined {
    const found = FONT_WEIGHTS[variable];
    return found ? "var(--font-weight-" + variable + "," + found + ")" : void 0;
  }
export const FONT_SIZES = {"pageHeader":"4rem","h1":"3rem","h2":"2.625rem","h3":"2.25rem","p":"1rem","small":"0.75rem"}  as const;
export function fontSizes(variable : keyof typeof FONT_SIZES) : string | undefined {
...
export function lineHeights(variable : keyof typeof LINE_HEIGHTS) : string | undefined {
    const found = LINE_HEIGHTS[variable];
    return found ? "var(--line-height-" + variable + "," + found + ")" : void 0;
  }
export const SIZES = {"containerWidth":"82.5rem","headerHeight":"5rem","headerHeightMobile":"3.75rem"}  as const;
...
export const RADII = {"small":"0.25rem","normal":"0.5rem","large":"0.75rem"}  as const;
